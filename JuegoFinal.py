...
class Jugador(pygame.sprite.Sprite):
    ...
    def __init__(self):
        ...
        super().__init__()
        #Rectangulo (jugador)
        self.image = pygame.image.load("C:/Users/julit/OneDrive/Imágenes/JUEGO/jugador.png")
...
class EnemigoNegro(pygame.sprite.Sprite):
    ...
    def __init__(self):
        ...
        super().__init__()
        #Rectangulo (enemigo)
        self.image = pygame.image.load("C:/Users/julit/OneDrive/Imágenes/JUEGO/enemigo.png")
        self.image.set_colorkey(BLANCO)
        #Obtiene el rectangulo (sprite)
        self.rect = self.image.get_rect()
        self.radius = 50
...
class EnemigoAmarillo(pygame.sprite.Sprite):
    ...
    def __init__(self):
        ...
        super().__init__()
        #Rectangulo (enemigo)
        self.image = pygame.image.load("C:/Users/julit/OneDrive/Imágenes/JUEGO/enemigo1.png")
        self.image.set_colorkey(BLANCO)
        #Obtiene el rectangulo (sprite)
        self.rect = self.image.get_rect()
        self.radius = 50
...
class EnemigoAzul(pygame.sprite.Sprite):
    ...
    def __init__(self):
        ...
        super().__init__()
        #Rectangulo (enemigo)
        self.image = pygame.image.load("C:/Users/julit/OneDrive/Imágenes/JUEGO/enemigo2.png")
        self.image.set_colorkey(BLANCO)
        #Obtiene el rectangulo (sprite)
        self.rect = self.image.get_rect()
        self.radius = 50
...
class EnemigoRojo(pygame.sprite.Sprite):
    ...
    def __init__(self):
        ...
        super().__init__()
        #Rectangulo (enemigo)
        self.image = pygame.image.load("C:/Users/julit/OneDrive/Imágenes/JUEGO/enemigo3.png")
        self.image.set_colorkey(BLANCO)
        #Obtiene el rectangulo (sprite)
        self.rect = self.image.get_rect()
        self.radius = 50
...
class Disparos(pygame.sprite.Sprite):
    def __init__(self, x, y):
        ...
        super().__init__()
        # Rectangulo (disparo)
        self.image = pygame.transform.scale(pygame.image.load("C:/Users/julit/OneDrive/Imágenes/JUEGO/disparo.png"),(5,35))
        self.image.set_colorkey(BLANCO)
        # Obtiene el rectangulo (sprite)
        self.rect = self.image.get_rect()
...
while ejecutando:
    ...
    if colision_negro:
        enemigonegro.image = pygame.image.load("C:/Users/julit/OneDrive/Imágenes/JUEGO/explosion.png")
    ...
    if colision_amarillo:
        enemigoamarillo.image = pygame.image.load("C:/Users/julit/OneDrive/Imágenes/JUEGO/explosion.png")
    ...
    if colision_azul:
        enemigoazul.image = pygame.image.load("C:/Users/julit/OneDrive/Imágenes/JUEGO/explosion.png")
    ...
    if colision_rojo:
        enemigorojo.image = pygame.image.load("C:/Users/julit/OneDrive/Imágenes/JUEGO/explosion.png")
    ...
    if jugador.bandera == False:
        ...
        muestra_texto(PANTALLA, consolas, str(escritura.mostrar_texto()), BLANCO, 25,80,50)
        barra_hp(PANTALLA, 750, 15, jugador.hp)
    if jugador.bandera == True:
        muestra_texto(PANTALLA, consolas, str('Ingrese nombre:'), AMARILLO,30,400,250)
    else:
        if jugador.cliente == True:
            eme = escritura.mostrar_texto()
            jugador.cliente = False
    ...
    if jugador.bandera == False:
        muestra_texto(PANTALLA, consolas, str(message), BLANCO, 25, 80, 85)
